							...
							<table id="dataList"
								...
								<c:forEach items="${pageInfo.list}" var="product">
									<tr>
										...
										<td>
												${fn:substring(product.departureTime, 0, 10)}
										</td>
...
<script type="text/javascript">
    ...
    function goToPage(currentPage) {
        ...
        location.href="${pageContext.request.contextPath}/product/findAll?currPage="+currentPage + "&pageSize=" + pageSize;
    }
</script>
<script
